...
class Constants {
    companion object{
        fun defaultExerciseList():ArrayList<ExerciseModel>{
            ...
            val stepUpOnChair = ExerciseModel(5,"stepUpOnChair", R.drawable.ic_step_up_onto_chair, false,false)
            ...
            val triceDipOnChair = ExerciseModel(7,"Trice Dip On Chair", R.drawable.ic_triceps_dip_on_chair, false,false)
            ...
            val highKneesRunningInPlace = ExerciseModel(9,"High Knees Running In Place", R.drawable.ic_wall_sit, false,false)
